namespace Metoda_Newtona
{
	partial class Interpolator
	{
		...
		private void InitializeComponent()
		{
			...
			this.sprawdzWynik_button.Margin = new System.Windows.Forms.Padding(2, 2, 2, 2);
			...
			this.miejsceZerowe_TextBox.Margin = new System.Windows.Forms.Padding(2, 2, 2, 2);
			...
			this.resetuj_button.Margin = new System.Windows.Forms.Padding(2, 2, 2, 2);
			...
			this.iteracje_TextBox.Margin = new System.Windows.Forms.Padding(2, 2, 2, 2);
			...
			this.delta_TextBox.Margin = new System.Windows.Forms.Padding(2, 2, 2, 2);
			...
			this.Oblicz_button.Margin = new System.Windows.Forms.Padding(2, 2, 2, 2);
			...
			this.epsilon_TextBox.Margin = new System.Windows.Forms.Padding(2, 2, 2, 2);
			...
			this.punktStartowy_TextBox.Margin = new System.Windows.Forms.Padding(2, 2, 2, 2);
			...
			this.punktStartowy_TextBox.Text = "2";
			// 
			// label_2
			// 
			...
			this.label_1.Location = new System.Drawing.Point(217, 56);
			...
			this.wspolczynniki_textbox1.Location = new System.Drawing.Point(357, 56);
			this.wspolczynniki_textbox1.Margin = new System.Windows.Forms.Padding(2, 2, 2, 2);
			...
			this.wspolczynniki_textbox1.Text = "3 -2 0";
			// 
			// saveButton
			// 
			...
			this.label1.Text = "Współczynniki dla y = 3x^3 - 2x^2";
			// 
			// label2
			// 
			...
			this.label2.Text = "Znaleznione zostanie najbliższe miejsce zerowe\r\nod punktu startowego";
			// 
			// Interpolator
			// 
